...
| [Fusion Analytics Platform](https://github.com/WilsonH918/fusion-analytics-platform) | dbt, SQL, BigQuery, Python, Oracle Fusion APIs, MCP | An analytics engineering platform for Oracle Fusion data. The project extracts raw Fusion data via APIs, models it using dbt following staging, intermediate, and mart layers, and enforces data quality through tests. It also includes a lightweight MCP server to manage user access and role assignments interactively, enabling governed analytics consumption. |
