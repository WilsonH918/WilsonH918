...
<h3 align="center">A passionate Data Architect/Data Engineer</h3>
...
|--------------|-------|---------------------|
| [Cloud-Native Trading Data Lakehouse (ELT Platform)](https://github.com/WilsonH918/trading-airflow-orchestrator) | Apache Airflow, dbt, PySpark, BigQuery, GCS, Cloud Run, Docker, GitHub Actions | End-to-end cloud-native ELT data platform on GCP built using a decoupled 3-repo architecture. It ingests financial data via containerized pipelines, stores raw data in GCS and exposes it through BigQuery external tables, then transforms it using dbt into staging, intermediate, and mart layers. The workflow is orchestrated using Airflow on Cloud Composer with metadata-driven watermarking for incremental loads, pipeline logging, and full run traceability. |
...
| [FusionOps dbt Analytics Engine](https://github.com/WilsonH918/fusion-analytics-platform) | dbt, SQL, BigQuery, Python, Oracle Fusion APIs, Model Context Protocol (MCP) | A dbt-first analytics engineering project for Oracle Fusion data. The solution ingests raw Fusion data via APIs, models it in BigQuery using layered dbt transformations (staging, intermediate, marts), and enforces data quality through tests and reusable macros. A lightweight MCP server is included to manage Fusion roles and data access, enabling governed analytics consumption. |
| [FabricOps MCP-Driven Data Architecture](https://github.com/WilsonH918/fabric-custom-remote-mcp) | Python, Azure Functions, Model Context Protocol (MCP), VNet, Microsoft Fabric REST API, Power BI | A custom remote MCP server hosted on Azure Functions that acts as a data architecture integration layer for AI agents. It exposes MCP tools to enable secure orchestration of Microsoft Fabric and Power BI operations, such as workspace creation, report analysis, DAX execution, and automated fixes via REST APIs and enterprise grade governance. |
...
![Azure DP600 cert](https://github.com/user-attachments/assets/033b6d61-8812-4916-9ebb-5dd50691a822)
